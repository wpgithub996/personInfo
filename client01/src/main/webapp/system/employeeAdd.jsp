...
<div class="formbody">
    ...
    <form action="servlet/EmployeeServlet?method=addEmp" method="post">
        <ul class="forminfo">
            <li>
                <label>用户名</label>
            ...
            <li>
                ...
                <input name="empType" type="radio" value="0" checked="checked" />基层员工&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <li>
                <label>紧急联系人信息</label>
                <textarea name="emer" cols="" rows="" id="ecp" class="textinput"></textarea>
            </li>
            <li>
                <label>身份证号</label>
